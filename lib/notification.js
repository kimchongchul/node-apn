...
Notification.prototype.clone = function (device) {
    ...
    notification.ano = this.ano;
    notification.brd_type = this.brd_type;
...
Notification.prototype.setUrl = function(url) {
    this.url = url;
    return this;
};
Notification.prototype.setAno = function(ano) {
    this.ano = ano;
    return this;
};
Notification.prototype.setBrdType = function(brd_type) {
...
Notification.prototype.toJSON = function () {
    ...
    if (typeof this.type == 'string') {
        this.payload.aps.type = this.type;
    }
    if (typeof this.url == 'string') {
        this.payload.aps.url = this.url;
    }
    if (typeof this.ano == 'string' || typeof this.ano == 'number') {
        this.payload.aps.ano = this.ano;
    }
    if (typeof this.brd_type == 'string') {
        this.payload.aps.brd_type = this.brd_type;
    }
